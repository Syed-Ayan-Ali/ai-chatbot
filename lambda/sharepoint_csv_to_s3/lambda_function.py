...
# Temporary hardcoded credentials — replace with your values for testing
...
def get_target_file(token, drive_id, file_name=TARGET_FILE_NAME):
    """Gets a specific file from the target SharePoint folder by name."""
